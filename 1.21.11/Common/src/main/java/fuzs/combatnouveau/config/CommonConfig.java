...
public class CommonConfig implements ConfigCore {
    ...
    List<String> attackSpeedOverridesRaw = KeyedValueProvider.asString(Registries.ITEM);
    ...
    List<String> entityInteractionRangeOverridesRaw = KeyedValueProvider.asString(Registries.ITEM);

...
public class CommonConfig implements ConfigCore {
    ...
    @Config(
            category = ServerConfig.ITEMS_CATEGORY,
    ...
    @Config(
            category = ServerConfig.SWEEPING_CATEGORY,
    ...
    @Config(
            category = ServerConfig.SHIELD_CATEGORY,
    ...
    @Config(
            category = ServerConfig.SHIELD_CATEGORY, description = {
    ...
    @Config(
            category = ATTRIBUTES_CATEGORY, name = "attack_damage_overrides", description = {
    ...
    @Config(
            category = ATTRIBUTES_CATEGORY, name = "attack_speed_overrides", description = {
    ...
    @Config(
            category = ATTRIBUTES_CATEGORY, name = "entity_interaction_range_overrides", description = {
